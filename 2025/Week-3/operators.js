...
const totalCost = applePrice * pickedApples;

console.log ("cost of Apples", totalCost);

console.log("Too many apples", pickedApples > 5);

// Eat a few apples and drop the rest cause I'm not eating 6 apple back to back
pickedApples -= 6;
